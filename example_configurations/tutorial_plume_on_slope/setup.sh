...
cd input
ln -s ../../../verification/tutorial_plume_on_slope/input/* ./

# Edit the data.pkg file to have the diagnostics_ob package
rm data.pkg
cp ../../../verification/tutorial_plume_on_slope/input/data.pkg data.pkg
sed -i '' -e '$ d' data.pkg
...
cd code
ln -s ../../../verification/tutorial_plume_on_slope/code/SIZE.h_mpi SIZE.h
ln -s ../../../verification/tutorial_plume_on_slope/code/OBCS_OPTIONS.h OBCS_OPTIONS.h
ln -s ../../../verification/tutorial_plume_on_slope/code/CPP_OPTIONS.h CPP_OPTIONS.h

# Edit the packages.conf file to have the diagnostics_ob package
cp ../../../verification/tutorial_plume_on_slope/code/packages.conf packages.conf
